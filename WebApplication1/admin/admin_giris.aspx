<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_giris.aspx.cs" Inherits="WebApplication1.admin.admin_giris" %>
                        ...
                        <form role="form" runat="server">
                            <fieldset>
                                <div class="form-group">
                                    <asp:TextBox ID="adminMailTxt" runat="server" CssClass="form-control" placeHolder="Email" OnTextChanged="adminMailTxt_TextChanged"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <asp:TextBox ID="adminSifreTxt" runat="server" CssClass="form-control" placeHolder="Şifre" TextMode="Password" OnTextChanged="adminSifreTxt_TextChanged"></asp:TextBox>
                                </div>
                                ...
                                <br />
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="adminMailTxt" ErrorMessage="Email tipinde değil.." ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                <br />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="adminMailTxt" ErrorMessage="Email boş..." ForeColor="Red"></asp:RequiredFieldValidator>
                                <br />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="adminSifreTxt" ErrorMessage="Şifre boş..." ForeColor="Red"></asp:RequiredFieldValidator>
                                <br />
